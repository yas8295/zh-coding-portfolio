        ...
        <div className="flex items-center space-x-4">
          ...
          {user ? (
            ...
            <button
              ...
              className={`hidden md:block px-4 py-2 rounded-full font-medium transition-colors ${
                isDark || !isScrolled
        ...
        <div className="py-4 space-y-2">
          ...
          <div className="border-t border-gray-700 pt-2 mt-2 p-2">
            {user ? (
              ...
              <button
                onClick={handleLoginClick}
                className={`block w-full px-4 py-2 rounded-full font-medium transition-colors ${
                  isDark
                    ? "bg-primary-600 text-white hover:bg-primary-700"
                    : "bg-primary-600 text-white hover:bg-primary-700"
                }`}
