      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 z-10 p-2 rounded-full bg-purple-600 text-white hover:bg-purple-700 transition-colors"
            >
              <X size={24} />
            </button>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    {packages.map((pkg: Package) => (
                      ...
                      >
                        ...
                        {selectedPackage === pkg.id && (
                          <div className="mt-4 p-2 rounded-lg bg-purple-600/20 text-purple-600 text-center text-sm font-semibold">
                            مختار ✓
                          </div>
                        )}
                      </motion.div>
